...
emptyState = CompState { topAlloc = 0,
                         table = emptyTable,
                         maxAlloc = 0,
                         countLabel = 0,
                         allocList = [], 
...
allocateLoc t state = CompState { maxAlloc   = max (maxAlloc state) (sizeOfType t + topAlloc state),
                                  table      = table state,
...
releaseLoc state = CompState { maxAlloc   = maxAlloc state,
                               table      = table state,
...
modifyLoc state i = CompState { maxAlloc   = max (maxAlloc state) i,
                               table      = table state,
                               topAlloc   = i,
                               countLabel = countLabel state,
...
modifyLabel l state = CompState { maxAlloc = maxAlloc state,
                                  table    = table state,
...
modifyFuncName name state = CompState { maxAlloc = maxAlloc state,
                                        table = table state,
                                        topAlloc = topAlloc state,
                                        countLabel = countLabel state,
                                        allocList = allocList state,
...
modifyTable stable state = CompState { maxAlloc = maxAlloc state,
                                       table = stable,
                                       topAlloc = topAlloc state,
                                       countLabel = countLabel state,
                                       allocList = allocList state,
